...
import convitesBoleiroRoutes from './routes/convites-boleiro.js';
...
import gruposFinanceiroRoutes from './routes/grupos-financeiro.js';
...
export async function buildApp(): Promise<FastifyInstance> {
  ...
  await app.register(gruposFinanceiroRoutes);
  ...
  await app.register(convitesBoleiroRoutes);
